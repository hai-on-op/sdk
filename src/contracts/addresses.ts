...
const tokens: Record<GebDeployment, TokenList> = {
    mainnet: {
        ...
        HAIVELOV2: {
            address: '0x20a7eaf4a922df50b312ef61aea8b6e1deb5ddd6',
            decimals: 18,
            symbol: 'HAIVELOV2',
            label: 'HAIVELOV2',
            bytes32String: HAIVELOV2,
            collateralJoin: '0x36bf76b8d62c8943bc6e684245c42fbf0253840d',
            collateralAuctionHouse: '0xd2873c157062abe35f619493e016e656a08b00c9',
            isCollateral: true,
            hasRewards: true,
        },
        HAIAERO: {
        ...
        'YV-VELO-MSETH-WETH': {
            address: '0xd0d2Ac44Cc842079e978bB11b094764f7D0dec6A',
            decimals: 18,
            symbol: 'YV-VELO-MSETH-WETH',
            label: 'YV-VELO-MSETH-WETH',
