...
const addresses: Record<GebDeployment, ContractList> = {
    mainnet: {
        ...
        STAKING_MANAGER: '0x0000000000000000000000000000000000000000',
        STAKING_TOKEN: '0x0000000000000000000000000000000000000000',
    },
    'optimism-goerli': {
        MULTICALL: '0xcA11bde05977b3631167028862bE2a173976CA11',
        ETH: '0x4200000000000000000000000000000000000006',
    ...
    'optimism-sepolia': {
        ...
        MERKLE_DISTRIBUTOR_FACTORY_OP: '0x524fE171e80173C15381bB50034033dA282abCc6',
        MERKLE_DISTRIBUTOR_FACTORY_DINERO: '0xFC4fD07b8CbA6b008952656a3d16A25da012EA56',
        STAKING_MANAGER: '0x5adB973008CFBdFd21A06d04A748b4D2B3750347',
        STAKING_TOKEN: '0x5adB973008CFBdFd21A06d04A748b4D2B3750347',
    },
}
...
const tokens: Record<GebDeployment, TokenList> = {
    ...
    'optimism-sepolia': {
        ...
        HAIVELO: {
            address: '0x3E2D4B6652198aa914c5365192b54B5a808fB7ba',
            decimals: 18,
            symbol: 'HAIVELO',
            label: 'HAIVELO',
            bytes32String: HAIVELO,
